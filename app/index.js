...
const Dashboard = () => {
  ...
  const CheckVersion = async () => {
    try {
      const res = await axios.post('http://dayaxpowers.com/api/save'
, 
        values,
      );
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.logoContainer}>
        ...
        <Image source={{uri: 'http://dayaxpowers.com/uploads/ktc_edit_sp/logo/logodayax.png_ktceditsp_20240925200242.png' }} style={styles.headerImg} alt='Logo' />
